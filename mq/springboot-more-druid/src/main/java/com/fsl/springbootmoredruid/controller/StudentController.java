package com.fsl.springbootmoredruid.controller;


import cn.hutool.core.util.RandomUtil;
import com.fsl.springbootmoredruid.dto.Student;
import com.fsl.springbootmoredruid.service.StudentServiceA;
import com.fsl.springbootmoredruid.service.StudentServiceB;
import com.fsl.springbootmoredruid.util.ServiceResult;
...
public class StudentController {
    ...
    @Autowired
    private StudentServiceA studentService;


    @Autowired
    private StudentServiceB studentServiceB;
    ...
    public ServiceResult test(){
        Student student = studentService.selectByPrimaryKey(996018439061522L);
        Student student1 = studentServiceB.selectByPrimaryKey(996018439061524L);
