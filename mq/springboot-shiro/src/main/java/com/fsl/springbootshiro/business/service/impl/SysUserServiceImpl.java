package com.fsl.springbootshiro.business.service.impl;

import com.fsl.springbootshiro.business.entity.User;
import com.fsl.springbootshiro.business.enums.UserStatusEnum;
import com.fsl.springbootshiro.business.service.SysRoleService;
...
import com.fsl.springbootshiro.persistence.mapper.SysUserMapper;
import com.fsl.springbootshiro.util.IpUtil;
    ...
    public boolean update(User user) {
        ...
        if (!StringUtils.isEmpty(user.getPassword())) {
            try {
                ...
                throw new YuddException("密码加密失败");
            }
        }
